...
const EditBranch = () => {
  ...
  useEffect(() => {
    ...
    const branchData = mockBranchData[id as keyof typeof mockBranchData];
    if (branchData) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Updating branch:', id, formData);
    // You can add API call here
    // navigate('/branch/all'); // Redirect after successful update
  };
  ...
  return (
    <>
      <PageMeta title="Edit Branch" description="Edit bank branch details" />

      <div className="space-y-6">
        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Edit New Branch</h2>
          <button
            onClick={handleBack}
