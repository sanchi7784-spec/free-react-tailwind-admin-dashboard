...
import logo from '../../../src/images/logo/flutterwave.png'
  ...
  return (
    <div>
        ...
        <h1 className='text-3xl dark:text-white' style={{fontWeight:"800"}}>Automatic-WithDraw</h1>
                ...
                <button className=' flex p-5 rounded-xl ml-3 dark:text-white h-15 text-black'><Webhook />Pending Withdraw</button>
