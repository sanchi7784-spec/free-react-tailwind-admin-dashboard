...
const AllTransfers: React.FC = () => {
  ...
  return (
    <>
      <PageMeta
        title="All Fund Transfer | Admin Dashboard"
        description="View and manage all fund transfers"
      />

      <div className="space-y-6">
        {/* Page Title */}
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">All Fund Transfer</h1>
        </div>
              ...
              <tbody>
                {allTransfersData.map((transfer) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-4">
                      <span className={`inline-flex rounded-full px-3 py-1 text-xs font-medium ${getStatusBadgeColor(transfer.status)}`}>
                        {transfer.status}
                      </span>
                    </td>
                    <td className="px-4 py-4">
                ...
                <div className="rounded-lg border border-gray-200 dark:border-gray-700">
                  ...
                  <div className="space-y-3 p-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className={`inline-flex rounded-full px-3 py-1 text-xs font-medium ${getStatusBadgeColor(selectedTransfer.status)}`}>
