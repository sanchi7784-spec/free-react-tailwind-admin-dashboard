...
export default function DisabledCustomers() {
  ...
  // Filter only disabled customers
  const disabledCustomers = customers.filter(c => c.status.toLowerCase() === 'disabled' || c.status.toLowerCase() === 'deactivated');
  ...
  return (
    <>
      <PageMeta title="Disabled Customers - Admin" description="Disabled customers listing" />
      <PageBreadcrumb pageTitle="Disabled Customers" />
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-1">
                      ...
                      <span className="inline-block bg-red-500 text-white px-3 py-1 rounded-full text-xs font-semibold whitespace-nowrap">
                        Deactivated
                      </span>
                    </div>
